...
extern float nv, kappa, buoyancy, dt, velScale, gravity, reactionTemperature, expansion, pctFuelBurn, stochiometricMixture, combustionHeat;
extern float kappa_fuel;
extern float kappa_exhaust;
extern float dissipation;
extern float dissipation_fuel;
extern float dissipation_exhaust;
extern float simTime;
extern float dx;
extern float refinementThreshold;
extern float mapIntensity;
extern float vorticityStrength;
extern int iterations, vizType;

extern double tpSrc[rows + 2][cols + 2];
extern double vxSrc[rows + 2][cols + 2];
extern double vySrc[rows + 2][cols + 2]; 
extern double fgSrc[rows + 2][cols + 2];
extern double egSrc[rows + 2][cols + 2];

extern double (*cur_tp)[cols + 2]; 
extern double(*cur_fg)[cols + 2];
extern double(*cur_eg)[cols + 2];
